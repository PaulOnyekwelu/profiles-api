...
PROJECT_GIT_URL='https://github.com/RxKachi/profiles-api.git'
...
git clone $PROJECT_GIT_URL $PROJECT_BASE_PATH/profiles-api
...
# Run migrations
cd $PROJECT_BASE_PATH/profiles-api/src
